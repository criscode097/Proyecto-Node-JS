...
console.log('=========================================');
console.log('[Plataforma de alquiler vacacional] - FICHA DE PRESENTACIÓN');
console.log('=========================================');
console.log('');
...
console.log('Plataforma de alquiler vacacional que conecta anfitriones con huéspedes para estadías únicas en todo el mundo.'); 
...
console.log('Categoría:       Turismo y hospitalidad');
...
console.log('Casas y departamentos disponibles para alquiler vacacional en destinos turísticos populares.');
...
console.log('Valor principal:    5000'); // TODO: reemplaza 5000 con tu número
...
console.log('Valor calculado precio con descuento:    ', 5000 * 0.8); // TODO: reemplaza 0 con tu cálculo
...
console.log('Estado booleano 1:  true'); // TODO: reemplaza 'true' con true o false

// TODO: Otro valor boolean diferente al anterior (true o false — sin comillas)
console.log('Estado booleano 2:  false'); // TODO: reemplaza 'false' con true o false]');
...
console.log('DreamStays es una plataforma de alquiler vacacional que conecta anfitriones con huéspedes para estadías únicas en todo el mundo. Ofrece una amplia variedad de alojamientos, desde casas y departamentos hasta villas y cabañas, en destinos turísticos populares. La plataforma se enfoca en brindar experiencias auténticas y personalizadas, permitiendo a los viajeros descubrir lugares únicos y a los anfitriones compartir sus espacios con personas de todo el mundo.');

// TODO: Escribe el nombre de tu dominio asignado (string)
// Ejemplos: 'Planetario', 'Acuario', 'Museo', 'Zoológico'
console.log('Dominio:          PLATAFORMA DE ALQUILER VACACIONAL');

// TODO: ¿Cómo se llama la entidad principal de tu dominio? (string)
// Ejemplos: 'exhibición', 'especie', 'obra', 'animal', 'evento'
console.log('Entidad:          Alojamiento'); 
...
console.log('Total registros:  1000');
...
console.log('Ficha de presentación de dominio creada por Cristian Martinez'); 

// TODO: Escribe un mensaje de cierre relacionado con tu dominio (string)
// Ejemplo (Planetario): '  ¡Explora el universo con JavaScript!'
console.log('Muchas gracias por conocer la ficha de presentación de DreamStays. ¡Descubre tu próximo destino vacacional con nosotros!');
